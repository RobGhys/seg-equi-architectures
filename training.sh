#!/bin/bash
#
#SBATCH --job-name=training_seg_bcnn
#SBATCH --array=0-4
...
python src/Benchmarks/training/main.py kvasir UNet_bcnn $SLURM_ARRAY_TASK_ID --save_logs --save_images --location_lucia --wandb_api_key $wandb_api_key
